...
# Customize a Generative AI RAG with Cloud SQL Solution

Learn how to build and deploy your own proof of concept based on the deployed [Generative AI RAG with Cloud SQL](https://console.cloud.google.com/products/solutions/details/generative-ai-rag) Jump Start Solution. You can customize the Jump Start Solution deployment by creating a copy of the source code. You can modify the infrastructure and application code as needed and redeploy the solution with the changes.
...
We also strongly recommend that you familiarize yourself with the Generative AI RAG with Cloud SQL solution by reading the [solution guide](https://cloud.google.com/architecture/big-data-analytics/generative-ai-rag).
